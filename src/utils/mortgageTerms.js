export const mortgageTerms = {
    ...
    monthlyPI: "The monthly payment for principal and interest (does not include taxes or insurance).",
    totalPaid: "The total amount paid over the life of the loan, including principal and interest.",
